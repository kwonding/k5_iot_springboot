...
/*
    ...
    1. 토큰 생성 (요청 자격 증명)
        ...
        - 상태: authenticated=false, principal=loginId, credentials=rawPassword(암호화 안 된)
    ...
    8. 인증 성공 토큰 생성
        ...
        - 상태: authenticated=true, principal=UserPrincipal, credentials=null(보안성 삭제), authorities 포함
