...
/*
    ...
    3) boolean existsById(Id id);
        : 주어진 Id가 존재하는지 확인 true/false 반환
    ...
    LessThan / LessThanEqual: 미만 / 이하 // boolean 반환
    GreaterThan / GreaterThanEqual: 초과 / 이상 // boolean 반환

    IsNull / IsNotNull: Null 여부 확인 - findByDescriptionIsNull // boolean 반환
...
public interface L_JpaRepository {
    ...
    // 카테고리와 가격 범위로 상품 조회
    List<Product> findByCategoryAndPrice(String category, int minPrice, int maxPrice);
